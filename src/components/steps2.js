          ...
          <div className="steps2-container3">
                ...
                {props.step1Description ?? (
                  <Fragment>
                    <span className="steps2-text29">
                      ...
                      needs and goals for VR therapy.
                    </span>
                  </Fragment>
                )}
              </span>
                ...
                {props.step2Description ?? (
                  <Fragment>
                    <span className="steps2-text31">
                      Based on the consultation, we will create a personalized
                      VR therapy plan tailored to your specific requirements.
                    </span>
                  </Fragment>
                )}
              </span>
                ...
                {props.step3Description ?? (
                  <Fragment>
                    <span className="steps2-text30">
                      Engage in immersive VR therapy sessions designed to
                      address your challenges and promote mental well-being.
                    </span>
                  </Fragment>
                )}
              </span>
            ...
            <div className="steps2-container7 thq-card">
              <h2 className="thq-heading-2">
                {props.step4Title ?? (
                  <Fragment>
                    <span className="steps2-text27">Progress Tracking</span>
                  </Fragment>
                )}
              </h2>
                ...
                {props.step4Description ?? (
                  <Fragment>
                    <span className="steps2-text32">
                      Track your progress throughout the VR therapy sessions and
