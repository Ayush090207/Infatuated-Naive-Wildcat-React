        ...
        <div data-thq="thq-navbar-nav" className="navbar8-desktop-menu">
          <nav className="navbar8-links1">
            ...
            >
              {props.link1 ?? (
                <Fragment>
                  <span className="navbar8-text15">Services</span>
                </Fragment>
              )}
            </a>
            <a href={props.link2Url} className="thq-link thq-body-small">
              {props.link2 ?? (
                <Fragment>
                  <span className="navbar8-text22">About</span>
                </Fragment>
              )}
            </a>
            <a
            ...
            >
              <span className="thq-link thq-body-small">
                {props.link4 ?? (
                  <Fragment>
                    <span className="navbar8-text16">Research</span>
                  </Fragment>
                )}
              </span>
                      ...
                      <div className="navbar8-menu-item1">
                        ...
                        <div className="navbar8-content1">
                          <span className="navbar8-page11 thq-body-large">
                            {props.page1 ?? (
                              <Fragment>
                                <span className="navbar8-text19">Page One</span>
                              </Fragment>
                            )}
                          </span>
                ...
                <div className="navbar8-menu-item7">
                  ...
                  <div className="navbar8-content7">
                    <span className="navbar8-page32 thq-body-large">
                      {props.page3 ?? (
                        <Fragment>
                          <span className="navbar8-text26">Page Three</span>
                        </Fragment>
                      )}
                    </span>
                    <span className="thq-body-small">
...
Navbar8.defaultProps = {
  ...
  link4: undefined,
  page2ImageSrc:
    'https://images.unsplash.com/photo-1711397818310-6a56aedff958?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1NDkzNTI4OHw&ixlib=rb-4.1.0&q=80&w=1080',
  link1Url: 'https://www.teleporthq.io',
  page1ImageSrc:
    'https://images.unsplash.com/photo-1490351267196-b7a67e26e41b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1NDkzNTI4N3w&ixlib=rb-4.1.0&q=80&w=1080',
  linkUrlPage3: 'https://www.teleporthq.io',
  link3Url: 'https://www.teleporthq.io',
  logoAlt: 'Neuronest Logo',
  page3Description: undefined,
  action1: undefined,
  page1: undefined,
  page1Description: undefined,
  page4ImageSrc:
    'https://images.unsplash.com/photo-1579154392429-0e6b4e850ad2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1NDkzNTI4N3w&ixlib=rb-4.1.0&q=80&w=1080',
  page2: undefined,
  link2: undefined,
  ...
  page3ImageSrc:
    'https://images.unsplash.com/photo-1642957098972-c6eee5915979?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1NDkzNTI4OHw&ixlib=rb-4.1.0&q=80&w=1080',
  page4: undefined,
  action2: undefined,
